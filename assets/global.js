        ...
        .then((text) => {
          ...
          jQuery(function ($) {
            ...
            function getProductVariants(productId) {
              ...
              if (scriptContent) {
                try {
                  var productVariants = JSON.parse(scriptContent);
                  console.log(
            ...
            $(".product-form__input input[type='radio']").on(
              "change",
              function () {
                var $radio = $(this);
                var productId = $radio
                ...
                var productVariantssss = getProductVariants(productId);
                console.log("getProductVariantsss:", productVariantssss);

                var matchingVariantId = null;
                if (productVariantssss && productVariantssss.variants) {
                  for (var i = 0; i < productVariantssss.variants.length; i++) {
                    var variant = productVariantssss.variants[i];
